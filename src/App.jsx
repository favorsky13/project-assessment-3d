        ...
        {!submitted ? (
          <>
            {sections.map((section, sectionIdx) => (
              <Card key={sectionIdx} className="bg-slate-800">
                  ...
                  {section.questions.map((q, qIdx) => (
                    <div key={qIdx} className="mb-2">
                      ...
                      <div className="space-x-2 mt-1">
                        <Button
                          variant={answers[`${sectionIdx}-${qIdx}`] === true ? "default" : "outline"}
                          onClick={() => handleAnswer(sectionIdx, qIdx, true)}>
                          Да
                        </Button>
                        <Button
                          variant={answers[`${sectionIdx}-${qIdx}`] === false ? "default" : "outline"}
            ...
            <Button onClick={handleSubmit} className="mt-4">Сформировать отчет</Button>
          </>
        ) : (
